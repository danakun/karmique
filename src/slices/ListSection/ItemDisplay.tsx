    ...
    >
      ...
      >
        <div className="flex h-full items-center justify-center">
          <ItemDisplayClient fragranceUid={fragrance.uid}>
            <Link href={`/fragrance/${fragrance.uid}`} className="block">
              <PrismicNextImage
            ...
            <div className="mt-4 mb-2 max-w-md text-lg text-black/70">
              <PrismicRichText field={fragrance.data.description} />
            </div>

            {/* Accords field */}
            <div className="mb-8 max-w-md text-base text-black/60">
              <PrismicRichText field={fragrance.data.accords} />
            </div>
